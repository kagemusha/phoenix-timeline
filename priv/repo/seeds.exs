...
peep_cards = [
  ...
  ["numberofpeoplewhounderstandembermetal.com goes from 4 to 5 (Martin Muñoz)", 2014, 8],
  ...
  ["NCSA Mosaic 1.0 released", 1993, 8],
  ["First EmberCamp in SF", 2013, 1],
  ["SproutCore 2.0's first commit", 2011, 3],
  ["Erik Bryn's begins contributing", 2011, 5],
  ["First ever Ember meetup (SF)", 2012, 1],
  ["Initial release of Backbone", 2010, 9],
  ["Apple announces MobileMe, written in SproutCore", 2008, 5],
  ["First Ember NYC Mascot, by Sam Penner!", 2013, 0],
  ["First ember-data 1.0 beta", 2013, 4],
  ["Last ember-data 1.0 beta", 2015, 5],
  ["Ember.js 2.0 drops", 2015, 7]
